# Auto generated from argolight_schema.yaml by pythongen.py version: 0.0.1
# Generation date: 2023-08-28T14:39:48
...
class ArgolightEInput(MetricsInput):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/samples/argolight_schema.yaml/ArgolightEInput")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "ArgolightEInput"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/samples/argolight_schema.yaml/ArgolightEInput")
...
class ArgolightEOutput(MetricsOutput):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/samples/argolight_schema.yaml/ArgolightEOutput")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "ArgolightEOutput"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/samples/argolight_schema.yaml/ArgolightEOutput")
...
class ArgolightEKeyValues(KeyValues):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/samples/argolight_schema.yaml/ArgolightEKeyValues")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "ArgolightEKeyValues"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/samples/argolight_schema.yaml/ArgolightEKeyValues")
...
slots.measured_band = Slot(uri=DEFAULT_.measured_band, name="measured_band", curie=DEFAULT_.curie('measured_band'),
                   model_uri=DEFAULT_.measured_band, domain=None, range=float)

slots.prominence_threshold = Slot(uri=DEFAULT_.prominence_threshold, name="prominence_threshold", curie=DEFAULT_.curie('prominence_threshold'),
                   model_uri=DEFAULT_.prominence_threshold, domain=None, range=float)

slots.focus_slice = Slot(uri=DEFAULT_.focus_slice, name="focus_slice", curie=DEFAULT_.curie('focus_slice'),
                   model_uri=DEFAULT_.focus_slice, domain=None, range=Optional[Union[int, List[int]]])

slots.rayleigh_resolution = Slot(uri=DEFAULT_.rayleigh_resolution, name="rayleigh_resolution", curie=DEFAULT_.curie('rayleigh_resolution'),
                   model_uri=DEFAULT_.rayleigh_resolution, domain=None, range=Optional[Union[float, List[float]]])

slots.peak_position_A = Slot(uri=DEFAULT_.peak_position_A, name="peak_position_A", curie=DEFAULT_.curie('peak_position_A'),
                   model_uri=DEFAULT_.peak_position_A, domain=None, range=Optional[Union[float, List[float]]])

slots.peak_position_B = Slot(uri=DEFAULT_.peak_position_B, name="peak_position_B", curie=DEFAULT_.curie('peak_position_B'),
                   model_uri=DEFAULT_.peak_position_B, domain=None, range=Optional[Union[float, List[float]]])

slots.peak_height_A = Slot(uri=DEFAULT_.peak_height_A, name="peak_height_A", curie=DEFAULT_.curie('peak_height_A'),
                   model_uri=DEFAULT_.peak_height_A, domain=None, range=Optional[Union[float, List[float]]])

slots.peak_height_B = Slot(uri=DEFAULT_.peak_height_B, name="peak_height_B", curie=DEFAULT_.curie('peak_height_B'),
                   model_uri=DEFAULT_.peak_height_B, domain=None, range=Optional[Union[float, List[float]]])

slots.peak_prominence_A = Slot(uri=DEFAULT_.peak_prominence_A, name="peak_prominence_A", curie=DEFAULT_.curie('peak_prominence_A'),
                   model_uri=DEFAULT_.peak_prominence_A, domain=None, range=Optional[Union[float, List[float]]])

slots.peak_prominence_B = Slot(uri=DEFAULT_.peak_prominence_B, name="peak_prominence_B", curie=DEFAULT_.curie('peak_prominence_B'),
                   model_uri=DEFAULT_.peak_prominence_B, domain=None, range=Optional[Union[float, List[float]]])
...
slots.argolightBOutput__spots_labels_image = Slot(uri=DEFAULT_.spots_labels_image, name="argolightBOutput__spots_labels_image", curie=DEFAULT_.curie('spots_labels_image'),
                   model_uri=DEFAULT_.argolightBOutput__spots_labels_image, domain=None, range=Optional[Union[str, ImageAsNumpyImageUrl]])
...
slots.argolightEDataset__input = Slot(uri=DEFAULT_.input, name="argolightEDataset__input", curie=DEFAULT_.curie('input'),
                   model_uri=DEFAULT_.argolightEDataset__input, domain=None, range=Union[dict, ArgolightEInput])

slots.argolightEDataset__output = Slot(uri=DEFAULT_.output, name="argolightEDataset__output", curie=DEFAULT_.curie('output'),
                   model_uri=DEFAULT_.argolightEDataset__output, domain=None, range=Optional[Union[dict, ArgolightEOutput]])

slots.argolightEOutput__peaks_rois = Slot(uri=DEFAULT_.peaks_rois, name="argolightEOutput__peaks_rois", curie=DEFAULT_.curie('peaks_rois'),
                   model_uri=DEFAULT_.argolightEOutput__peaks_rois, domain=None, range=Optional[Union[Union[dict, ROI], List[Union[dict, ROI]]]])

slots.argolightEOutput__key_measurements = Slot(uri=DEFAULT_.key_measurements, name="argolightEOutput__key_measurements", curie=DEFAULT_.curie('key_measurements'),
                   model_uri=DEFAULT_.argolightEOutput__key_measurements, domain=None, range=Optional[Union[dict, ArgolightEKeyValues]])

slots.argolightEOutput__intensity_profiles = Slot(uri=DEFAULT_.intensity_profiles, name="argolightEOutput__intensity_profiles", curie=DEFAULT_.curie('intensity_profiles'),
                   model_uri=DEFAULT_.argolightEOutput__intensity_profiles, domain=None, range=Optional[Union[dict, TableAsDict]])
