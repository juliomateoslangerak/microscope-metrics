...
# Generation date: 2023-08-16T08:01:18
...
from ..core_schema import Column, ColumnName, ExperimenterOrcid, Image5D, ImageAsNumpy, KeyValues, MetricsDataset, MetricsInput, MetricsOutput, ROI, SampleType, TableAsDict
...
# Class references
class IntensityProfileName(ColumnName):
    pass
...
class FieldIlluminationOutput(MetricsOutput):
    ...
    intensity_profiles: Optional[Union[dict, "IntensityProfilesTable"]] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.intensity_profiles is not None and not isinstance(self.intensity_profiles, IntensityProfilesTable):
            self.intensity_profiles = IntensityProfilesTable(**as_dict(self.intensity_profiles))
...
@dataclass
class IntensityProfilesTable(TableAsDict):
    """
    A table containing the intensity plots across the different axes of the input image
    """
    _inherited_slots: ClassVar[List[str]] = []

    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/samples/field_illumination_schema.yaml/IntensityProfilesTable")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "IntensityProfilesTable"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/samples/field_illumination_schema.yaml/IntensityProfilesTable")

    columns: Optional[Union[str, IntensityProfileName]] = None

    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self.columns is not None and not isinstance(self.columns, IntensityProfileName):
            self.columns = IntensityProfileName(self.columns)

        super().__post_init__(**kwargs)


@dataclass
class IntensityProfile(Column):
    _inherited_slots: ClassVar[List[str]] = []

    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/samples/field_illumination_schema.yaml/IntensityProfile")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "IntensityProfile"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/samples/field_illumination_schema.yaml/IntensityProfile")

    name: Union[str, IntensityProfileName] = None
    values: Optional[float] = None

    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self._is_empty(self.name):
            self.MissingRequiredField("name")
        if not isinstance(self.name, IntensityProfileName):
            self.name = IntensityProfileName(self.name)
...
slots.fieldIlluminationOutput__intensity_profiles = Slot(uri=DEFAULT_.intensity_profiles, name="fieldIlluminationOutput__intensity_profiles", curie=DEFAULT_.curie('intensity_profiles'),
                   model_uri=DEFAULT_.fieldIlluminationOutput__intensity_profiles, domain=None, range=Optional[Union[dict, IntensityProfilesTable]])
...
slots.fieldIlluminationOutput__intensity_map = Slot(uri=DEFAULT_.intensity_map, name="fieldIlluminationOutput__intensity_map", curie=DEFAULT_.curie('intensity_map'),
                   model_uri=DEFAULT_.fieldIlluminationOutput__intensity_map, domain=None, range=Optional[Union[dict, Image5D]])
...
slots.intensityProfilesTable__columns = Slot(uri=DEFAULT_.columns, name="intensityProfilesTable__columns", curie=DEFAULT_.curie('columns'),
                   model_uri=DEFAULT_.intensityProfilesTable__columns, domain=None, range=Optional[Union[str, IntensityProfileName]])

slots.intensityProfile__values = Slot(uri=DEFAULT_.values, name="intensityProfile__values", curie=DEFAULT_.curie('values'),
                   model_uri=DEFAULT_.intensityProfile__values, domain=None, range=Optional[float])
