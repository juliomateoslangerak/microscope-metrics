...
# Generation date: 2023-08-28T14:39:41
...
DEFAULT_ = CurieNamespace('', 'https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/')
...
class NamedObject(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/NamedObject")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "NamedObject"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/NamedObject")
...
class MetricsObject(NamedObject):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/MetricsObject")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "MetricsObject"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/MetricsObject")
...
class Sample(NamedObject):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Sample")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "Sample"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Sample")
...
class Protocol(NamedObject):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Protocol")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "Protocol"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Protocol")
...
class Experimenter(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Experimenter")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "Experimenter"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Experimenter")
...
class MetricsDataset(NamedObject):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/MetricsDataset")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "MetricsDataset"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/MetricsDataset")
...
class MetricsInput(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/MetricsInput")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "MetricsInput"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/MetricsInput")
...
class MetricsOutput(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/MetricsOutput")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "MetricsOutput"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/MetricsOutput")
...
class Image(MetricsObject):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Image")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "Image"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Image")
...
class ImageAsNumpy(Image):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/ImageAsNumpy")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "ImageAsNumpy"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/ImageAsNumpy")
...
class ImageInline(Image):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/ImageInline")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "ImageInline"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/ImageInline")
...
class ImageMask(ImageInline):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/ImageMask")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "ImageMask"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/ImageMask")
...
class Image2D(ImageInline):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Image2D")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "Image2D"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Image2D")
...
class Image5D(ImageInline):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Image5D")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "Image5D"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Image5D")
...
class PixelSeries(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/PixelSeries")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "PixelSeries"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/PixelSeries")
...
class ChannelSeries(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/ChannelSeries")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "ChannelSeries"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/ChannelSeries")
...
class TimeSeries(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/TimeSeries")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "TimeSeries"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/TimeSeries")
...
class ROI(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/ROI")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "ROI"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/ROI")
...
class Shape(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Shape")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "Shape"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Shape")
...
class Point(Shape):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Point")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "Point"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Point")
...
class Line(Shape):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Line")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "Line"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Line")
...
class Rectangle(Shape):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Rectangle")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "Rectangle"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Rectangle")
...
class Ellipse(Shape):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Ellipse")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "Ellipse"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Ellipse")
...
class Polygon(Shape):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Polygon")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "Polygon"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Polygon")
...
class Vertex(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Vertex")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "Vertex"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Vertex")
...
class Mask(Shape):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Mask")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "Mask"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Mask")
...
class Color(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Color")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "Color"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Color")
...
class KeyValues(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/KeyValues")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "KeyValues"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/KeyValues")
...
class Tag(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Tag")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "Tag"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Tag")
...
class Comment(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Comment")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "Comment"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Comment")
...
class Table(MetricsObject):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Table")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "Table"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Table")
...
class TableAsPandasDF(Table):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/TableAsPandasDF")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "TableAsPandasDF"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/TableAsPandasDF")
...
class TableAsDict(Table):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/TableAsDict")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "TableAsDict"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/TableAsDict")
...
class Column(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Column")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "Column"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/MontpellierRessourcesImagerie/microscope-metrics/blob/main/src/microscopemetrics/data_schema/core_schema.yaml/Column")
...
slots.image_url = Slot(uri=DEFAULT_.image_url, name="image_url", curie=DEFAULT_.curie('image_url'),
                   model_uri=DEFAULT_.image_url, domain=None, range=URIRef)

slots.source_image_url = Slot(uri=DEFAULT_.source_image_url, name="source_image_url", curie=DEFAULT_.curie('source_image_url'),
                   model_uri=DEFAULT_.source_image_url, domain=None, range=Optional[Union[str, List[str]]])
...
slots.bit_depth = Slot(uri=DEFAULT_.bit_depth, name="bit_depth", curie=DEFAULT_.curie('bit_depth'),
                   model_uri=DEFAULT_.bit_depth, domain=None, range=Optional[int])

slots.saturation_threshold = Slot(uri=DEFAULT_.saturation_threshold, name="saturation_threshold", curie=DEFAULT_.curie('saturation_threshold'),
                   model_uri=DEFAULT_.saturation_threshold, domain=None, range=Optional[float])

slots.sample__type = Slot(uri=DEFAULT_.type, name="sample__type", curie=DEFAULT_.curie('type'),
                   model_uri=DEFAULT_.sample__type, domain=None, range=URIRef)

slots.sample__protocol = Slot(uri=DEFAULT_.protocol, name="sample__protocol", curie=DEFAULT_.curie('protocol'),
                   model_uri=DEFAULT_.sample__protocol, domain=None, range=Union[str, ProtocolUrl])
...
slots.protocol__url = Slot(uri=DEFAULT_.url, name="protocol__url", curie=DEFAULT_.curie('url'),
                   model_uri=DEFAULT_.protocol__url, domain=None, range=URIRef)

slots.experimenter__name = Slot(uri=DEFAULT_.name, name="experimenter__name", curie=DEFAULT_.curie('name'),
                   model_uri=DEFAULT_.experimenter__name, domain=None, range=str)
...
slots.metricsDataset__sample = Slot(uri=DEFAULT_.sample, name="metricsDataset__sample", curie=DEFAULT_.curie('sample'),
                   model_uri=DEFAULT_.metricsDataset__sample, domain=None, range=Optional[Union[str, SampleType]])
...
slots.metricsDataset__acquisition_date = Slot(uri=DEFAULT_.acquisition_date, name="metricsDataset__acquisition_date", curie=DEFAULT_.curie('acquisition_date'),
                   model_uri=DEFAULT_.metricsDataset__acquisition_date, domain=None, range=Optional[Union[str, XSDDate]])

slots.metricsDataset__processed = Slot(uri=DEFAULT_.processed, name="metricsDataset__processed", curie=DEFAULT_.curie('processed'),
                   model_uri=DEFAULT_.metricsDataset__processed, domain=None, range=Union[bool, Bool])

slots.metricsDataset__processing_date = Slot(uri=DEFAULT_.processing_date, name="metricsDataset__processing_date", curie=DEFAULT_.curie('processing_date'),
                   model_uri=DEFAULT_.metricsDataset__processing_date, domain=None, range=Optional[Union[str, XSDDate]])

slots.metricsDataset__processing_log = Slot(uri=DEFAULT_.processing_log, name="metricsDataset__processing_log", curie=DEFAULT_.curie('processing_log'),
                   model_uri=DEFAULT_.metricsDataset__processing_log, domain=None, range=Optional[str])

slots.metricsDataset__comment = Slot(uri=DEFAULT_.comment, name="metricsDataset__comment", curie=DEFAULT_.curie('comment'),
                   model_uri=DEFAULT_.metricsDataset__comment, domain=None, range=Optional[Union[Union[dict, Comment], List[Union[dict, Comment]]]])

slots.imageAsNumpy__data = Slot(uri=DEFAULT_.data, name="imageAsNumpy__data", curie=DEFAULT_.curie('data'),
                   model_uri=DEFAULT_.imageAsNumpy__data, domain=None, range=Optional[Union[dict, MetaObject]])
...
slots.imageMask__data = Slot(uri=DEFAULT_.data, name="imageMask__data", curie=DEFAULT_.curie('data'),
                   model_uri=DEFAULT_.imageMask__data, domain=None, range=Union[Union[bool, Bool], List[Union[bool, Bool]]])
...
slots.image2D__data = Slot(uri=DEFAULT_.data, name="image2D__data", curie=DEFAULT_.curie('data'),
                   model_uri=DEFAULT_.image2D__data, domain=None, range=Union[float, List[float]])
...
slots.image5D__data = Slot(uri=DEFAULT_.data, name="image5D__data", curie=DEFAULT_.curie('data'),
                   model_uri=DEFAULT_.image5D__data, domain=None, range=Union[float, List[float]])
...
slots.channelSeries__values = Slot(uri=DEFAULT_.values, name="channelSeries__values", curie=DEFAULT_.curie('values'),
                   model_uri=DEFAULT_.channelSeries__values, domain=None, range=Union[int, List[int]])
...
slots.rOI__label = Slot(uri=DEFAULT_.label, name="rOI__label", curie=DEFAULT_.curie('label'),
                   model_uri=DEFAULT_.rOI__label, domain=None, range=Optional[str])

slots.rOI__description = Slot(uri=DEFAULT_.description, name="rOI__description", curie=DEFAULT_.curie('description'),
                   model_uri=DEFAULT_.rOI__description, domain=None, range=Optional[str])

slots.rOI__image = Slot(uri=DEFAULT_.image, name="rOI__image", curie=DEFAULT_.curie('image'),
                   model_uri=DEFAULT_.rOI__image, domain=None, range=Optional[Union[Union[str, ImageImageUrl], List[Union[str, ImageImageUrl]]]])
...
slots.shape__label = Slot(uri=DEFAULT_.label, name="shape__label", curie=DEFAULT_.curie('label'),
                   model_uri=DEFAULT_.shape__label, domain=None, range=Optional[str])
...
slots.polygon__is_open = Slot(uri=DEFAULT_.is_open, name="polygon__is_open", curie=DEFAULT_.curie('is_open'),
                   model_uri=DEFAULT_.polygon__is_open, domain=None, range=Union[bool, Bool])
...
slots.mask__y = Slot(uri=DEFAULT_.y, name="mask__y", curie=DEFAULT_.curie('y'),
                   model_uri=DEFAULT_.mask__y, domain=None, range=int)

slots.mask__x = Slot(uri=DEFAULT_.x, name="mask__x", curie=DEFAULT_.curie('x'),
                   model_uri=DEFAULT_.mask__x, domain=None, range=int)

slots.mask__mask = Slot(uri=DEFAULT_.mask, name="mask__mask", curie=DEFAULT_.curie('mask'),
                   model_uri=DEFAULT_.mask__mask, domain=None, range=Optional[Union[dict, ImageMask]])
...
slots.tableAsPandasDF__df = Slot(uri=DEFAULT_.df, name="tableAsPandasDF__df", curie=DEFAULT_.curie('df'),
                   model_uri=DEFAULT_.tableAsPandasDF__df, domain=None, range=Union[dict, MetaObject])

slots.tableAsDict__columns = Slot(uri=DEFAULT_.columns, name="tableAsDict__columns", curie=DEFAULT_.curie('columns'),
                   model_uri=DEFAULT_.tableAsDict__columns, domain=None, range=Union[Dict[Union[str, ColumnName], Union[dict, Column]], List[Union[dict, Column]]])

slots.column__name = Slot(uri=DEFAULT_.name, name="column__name", curie=DEFAULT_.curie('name'),
                   model_uri=DEFAULT_.column__name, domain=None, range=URIRef)
