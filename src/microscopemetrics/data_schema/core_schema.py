...
# Generation date: 2023-08-16T07:57:15
...
slots.uri = Slot(uri=DEFAULT_.uri, name="uri", curie=DEFAULT_.curie('uri'),
                   model_uri=DEFAULT_.uri, domain=None, range=Optional[Union[str, URI]])
...
slots.imageMask__y_position = Slot(uri=DEFAULT_.y_position, name="imageMask__y_position", curie=DEFAULT_.curie('y_position'),
                   model_uri=DEFAULT_.imageMask__y_position, domain=None, range=Optional[int])

slots.imageMask__x_position = Slot(uri=DEFAULT_.x_position, name="imageMask__x_position", curie=DEFAULT_.curie('x_position'),
                   model_uri=DEFAULT_.imageMask__x_position, domain=None, range=Optional[int])
...
slots.rOI__image = Slot(uri=DEFAULT_.image, name="rOI__image", curie=DEFAULT_.curie('image'),
                   model_uri=DEFAULT_.rOI__image, domain=None, range=Union[Union[dict, Image], List[Union[dict, Image]]])
