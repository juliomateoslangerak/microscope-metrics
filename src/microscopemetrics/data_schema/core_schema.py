...
# Generation date: 2023-08-30T16:52:33
...
class MetricsDataset(NamedObject):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self._normalize_inlined_as_dict(
            slot_name="comment", slot_type=Comment, key_name="text", keyed=False
        )
...
slots.metricsDataset__comment = Slot(
    uri=DEFAULT_.comment,
    name="metricsDataset__comment",
    curie=DEFAULT_.curie("comment"),
    model_uri=DEFAULT_.metricsDataset__comment,
    domain=None,
    range=Optional[Union[Union[dict, Comment], List[Union[dict, Comment]]]],
)
